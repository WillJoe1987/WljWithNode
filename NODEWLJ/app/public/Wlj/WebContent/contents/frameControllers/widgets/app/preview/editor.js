...
//    var objInspector = new Ext.debug.ObjectInspector();
	var scriptPanel = new Wlj.functions.preview.util.WljScriptEditor();
	window._SCRIPTPANEL = scriptPanel;
...
Ext.debug.ScriptsPanel = Ext.extend(Ext.Panel, {
    ...
    onRender : function(ct, position){
    	...
    	this.codeEedit = new CodeMirror(this.body.dom);
    },

    evalScript : function(){
        var s = this.codeEedit.doc.getValue();
...
(function(){
	var fieldsContainer = new Ext.Panel({
		title : 'fileds',
		layout : 'accordion',
		style: 'position:absolute;right:0;top:0;z-index:101',
		height : 500,
		width : 300,
		autoScroll : true,
		layoutConfig: {
