...
API = {
	...
	setFieldTile : true,
	addStepData : true,
	getViewTotalIndex : true,
	showViewByTotalIndex : true,
	getStat : true,
	initStat : true,
	/**
	...
	/**
	 * 根据标题获取封装的原生面板对象
	 * @param title : 封装的原生面板标题
	 * @return array[object]
	 */
	getExtPanelByTitle : true,
	 ...
	 * 		linktable : String/Object, 联动主表的名称(仅限'searchGridView')或对象
	 * @return 表格,从属表格,表单,从属表单,以及原生的Ext面板对象. 创建失败时返回false
	 */
	buildExtPanel : true,
	/**
